...
import 'package:perpus_crud_app/controllers/perpus_controller.dart';
import 'package:perpus_crud_app/models/Perpus.dart';
import 'package:perpus_crud_app/widgets/modals.dart';
import 'package:perpus_crud_app/widgets/bottomnav.dart';
                ...
                return Card(
                  ...
                  child: Padding(
                    ...
                    child: ClipRRect(
                      borderRadius: BorderRadius.circular(8),
                      child: Image.asset(
                        buku![index].cover, // Assuming cover holds the asset path
                        fit: BoxFit.cover,
